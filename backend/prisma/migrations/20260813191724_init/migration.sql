-- CreateEnum
CREATE TYPE "Role" AS ENUM ('MANAGER', 'ACCOUNTANT', 'CASHIER');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH', 'CARD', 'MIXED');

-- CreateEnum
CREATE TYPE "AdjustmentReason" AS ENUM ('RESTOCK', 'DAMAGE', 'CORRECTION', 'RETURN');
...
CREATE TABLE "Product" (
    ...
    "reorderLevel" DECIMAL(10,3) NOT NULL DEFAULT 5,
    "active" BOOLEAN NOT NULL DEFAULT true,
    "categoryId" TEXT,
    "supplierId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
